...
namespace Services
{
    ...
    public class HPUWebService : System.Web.Services.WebService
    {
        ...
        {
            //SqlConnection conn = new SqlConnection("Server=10.1.0.246;Database=EduMngNew;UID=...;PWD=...");
          //SqlConnection conn = new SqlConnection("Server=10.1.0.236;Database=EduMngNew;UID=...;PWD=...");
            return conn;
        }
